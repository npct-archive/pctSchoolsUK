...
Active travel to school offers many benefits across a range of policy objectives. From a public health perspective it contributes to the physical and mental wellbeing of new generations (ref). Active travel to school also has environmental benefits, in the form of reduced motorised traffic and improved air quality (ref). A knock-on health co-benefit reduced levels of danger of road traffic casualties resulting from the reduction in road traffic. From an education perspective, physical and mental barriers to educational success can be reduced by physical activity, and there is evidence to suggest that active travel to school can improve student learning (ref).

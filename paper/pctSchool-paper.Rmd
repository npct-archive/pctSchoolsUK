...
if(!file.exists("paper/figures/schools_england.png") | !file.exists("paper/figures/flows_england.png")){
...
if(!file.exists("paper/figures/pcycle_schools.png") | !file.exists("paper/figures/pcycle_work.png")){
  #png(file="paper/figures/pcycle_schools.png")
  ...
  #png(file = "paper/figures/pcycle_work.png")
...
```{r, echo=FALSE, fig.cap="The fraction of commuting pupils choosing to cycle to school, as a function of the commute distance (via the fastest route network-level path) and the gradient of the path."}
